...
TwitterUserProfile  = LOAD 'fixd/flattened/twitter_user_profile.tsv'        AS (rsrc: chararray, user_id: int, scraped_at: long, full_name:   chararray, url: chararray, location: chararray, description: chararray, time_zone: chararray, utc_offset: int);
TwitterUserStyle    = LOAD 'fixd/flattened/twitter_user_style.tsv'          AS (rsrc: chararray, user_id: int, scraped_at: long, profile_background_color: chararray, profile_text_color: chararray, profile_link_color: chararray, profile_sidebar_border_color: chararray, profile_sidebar_fill_color: chararray, profile_background_tile: int, profile_background_image_url: chararray, profile_image_url: chararray);
